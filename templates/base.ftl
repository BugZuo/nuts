...
<@block name="baseCss">
  <link id="callCss" rel="stylesheet" href="${staticPrefix("/css/base/bootstrap.min.css")}"
        type="text/css" media="screen" charset="utf-8"/>

  <link id="callCss" rel="stylesheet" href="${staticPrefix("/css/base/style.css")}"
...
<div id="headerSection">
  <div class="container">
    <div class="span3 logo"><a href="#"><img src="${staticPrefix("/img/base/logo1.png")}"
                                             alt=""/></a></div>
  ...
  <div id="myCarousel" class="carousel slide">
    ...
    <div class="carousel-inner">
      <div class="item active">
        <a class="cntr" href="#"><img src="${staticPrefix("/img/base/1.png")}" alt=""></a>
      </div>
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-4 col-xs-12">
        ...
        <div class="info-img">
          <img src="${staticPrefix("/img/base/img-1.png")}"></div>
        <h4>Flat Design</h4>
        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed et quam est. Mauris
          faucibus tellus ac auctor posuere. </p>
      </div>
      <div class="col-md-4 col-xs-12">
        <div class="info-img"><img src="${staticPrefix("/img/base/img-2.png")}"></div>
        <h4>Great Ideas</h4>
        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed et quam est. Mauris
          faucibus tellus ac auctor posuere. </p>
      </div>
      <div class="col-md-4 col-xs-12">
        <div class="info-img"><img src="${staticPrefix("/img/base/img-3.png")}"></div>
        ...
        <div class="tab-pane active" id="all">
          <ul class="thumbnails">
              ...
              <div class="thumbnail">
                <div class="blockDtl">
                  <a href="#myModal1" role="button" data-toggle="modal">
                    <img src="${staticPrefix("/img/base/img-4.png")}" alt="">
                  </a>
                </div>
              </div>
            </li>
            <li class="col-md-4 col-xs-6">
              <div class="thumbnail">
                <div class="blockDtl">
                  <a href="#"><img src="${staticPrefix("/img/base/img-5.png")}" alt=""></a>
                </div>
              </div>
            </li>
            <li class="col-md-4 col-xs-6">
              <div class="thumbnail">
                <div class="blockDtl">
                  <a href="#"><img src="${staticPrefix("/img/base/img-6.png")}" alt=""></a>
                </div>
              </div>
            </li>
            <li class="col-md-4 col-xs-6">
              <div class="thumbnail">
                <div class="blockDtl">
                  <a href="#"><img src="${staticPrefix("/img/base/img-7.png")}" alt=""></a>
                </div>
              </div>
            </li>
            <li class="col-md-4 col-xs-6">
              <div class="thumbnail">
                <div class="blockDtl">
                  <a href="#"><img src="${staticPrefix("/img/base/img-8.png")}" alt=""></a>
                </div>
              </div>
            </li>
            <li class="col-md-4 col-xs-6">
              <div class="thumbnail">
                <div class="blockDtl">
                  <a href="#"><img src="${staticPrefix("/img/base/img-9.png")}" alt=""></a>
                </div>
              </div>
            </li>
          ...
          <ul class="thumbnails">
            ...
            <li class="col-md-4 col-xs-6">
              <div class="thumbnail">
                <div class="blockDtl">
                  <a href="#myModal1" role="button" data-toggle="modal">
                    <img src="${staticPrefix("/img/base/img-5.png")}" alt="">
                  </a>
                </div>
              </div>
            </li>
            <li class="col-md-4 col-xs-6">
              <div class="thumbnail">
                <div class="blockDtl">
                  <a href="#"><img src="${staticPrefix("/img/base/img-4.png")}" alt=""></a>
                </div>
              </div>
            </li>
            <li class="col-md-4 col-xs-6">
              ...
              <div class="thumbnail">
                <div class="blockDtl">
                  <a href="#myModal1" role="button" data-toggle="modal"><img
                          src="${staticPrefix("/img/base/img-5.png")}" alt=""></a>
                </div>
              </div>
            </li>
            <li class="col-md-4 col-xs-6">
          ...
          <ul class="thumbnails">
            ...
            <li class="col-md-4 col-xs-6">
              <div class="thumbnail">
                <div class="blockDtl">
                  <a href="#myModal1" role="button" data-toggle="modal"><img
                          src="${staticPrefix("/img/base/img-7.png")}" alt=""></a>
                </div>
              </div>
            </li>
            <li class="col-md-4 col-xs-6">
  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-lg-4 col-md-12">
        <img class="r-image" src="${staticPrefix("/img/base/img-10.png")}" alt=""/>
      </div>
        ...
        <div class="tab-pane active" id="all">
          <ul class="thumbnails">
            ...
            <li class="col-sm-4 col-xs-12">
              <div class="thumbnail">
                <div class="blockDtl">
                  <a href="#"><img src="${staticPrefix("/img/base/img-11.png")}" alt=""></a>
                  <h4>JOHN SMITH</h4>
        ...
        <div class="tab-pane active" id="all">
          <ul class="thumbnails">
            ...
            <li class="col-sm-4 col-xs-12">
              <div class="thumbnail">
                <div class="blockDtl">
                  <a href="#"><img src="${staticPrefix("/img/base/img-12.png")}" alt=""></a>
...
<@block name="baseJs">
<script src="${staticPrefix("/js/base/jquery-1.9.1.min.js")}"></script>
<script src="${staticPrefix("/js/base/bootstrap.min.js")}" type="text/javascript"></script>
<script src="${staticPrefix("/js/base/jquery.scrollTo-1.4.3.1-min.js")}" type="text/javascript"></script>
<script src="${staticPrefix("/js/base/jquery.easing-1.3.min.js")}"></script>
<script src="${staticPrefix("/js/base/default.js")}"></script>
</@block>
